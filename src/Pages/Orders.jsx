...
const Orders = ({ checkoutSelectedProducts, setCheckoutSelectedProducts }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-center gap-5 ">
                <div className="w-full p-3  border rounded my-5 max-w-[700px]  px-5">
            ...
            <div className="flex justify-between flex-wrap w-fit gap-5 mx-auto">
                <ul className="flex flex-col divide-y dark:divide-gray-300 w-full lg:w-fit pr-5">
                                    ...
                                    <div className=" block md:flex justify-between w-full pb-2 space-x-2">
                                        ...
                                        <div className=" flex lg:flex-col-reverse  item-center gap-x-5  justify-between">
                                            ...
                                            <div className="text-right">
                                                <h2>Quantity: {product.orderQuantity}</h2>
                                                <p className="text-md font-semibold">Total : <span className='text-xl min-w-32'>{product.price * product.orderQuantity} /-</span></p>
                                            </div>
                                        </div>
                                    </div>
